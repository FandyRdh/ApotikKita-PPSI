...
<div class="container Konten">
        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav btn-Konten">
                    ...
                    <li class="nav-item active ">
                        <a class="nav-link link-halaman Konten-Terpilih" href="/Database/Obat">Obat</a>
                    </li>
                    <li class="nav-item active">
    ...
    <div class="container Sub-Konten">
        <p class="Judul-Sub-Konten">Obat
            <button type="button" data-toggle="modal" data-target="#InsertObat" class="btn Insert-Data">&nbsp;&nbsp;Insert &nbsp;&nbsp;</button>
        </p>
            ...
            <tbody>
                <?php foreach ($Obat->getResultArray() as $O) : ?>
                    <tr>
                        ...
                        <td> <a class="btn Detail-Data" href="/Database/Obat/Detail/<?= $O['KODE_OBAT']; ?>">&nbsp;&nbsp;Detail&nbsp;&nbsp;</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<!-- Modal Fungsi -->
<!-- Insert -->
<div class="modal fade bd-example-modal-lg" id="InsertObat" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form action="/Database/Obat/Save">
                <?= csrf_field(); ?>
