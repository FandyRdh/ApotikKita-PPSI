...
<head>
    ...
    <!-- CSS -->
    <link href="<?= base_url('assets/Kasir/css/Style_Kasir.css'); ?>" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container">
            <a class="navbar-brand">Apotik Kita</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto btn-halaman">
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Pembelian">Kasir</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Stok_Obat">Stok Obat</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Laporan_Kasir">Laporan</a>
                    </li>
                </ul>
