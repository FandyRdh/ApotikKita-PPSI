                ...
                <div class="col-sm Detail-Data-Obat">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <a class="btn btn-danger" href="/Gudang/Obat/Hapus/<?= $O['KODE_OBAT']; ?>">&nbsp;&nbsp;Hapus&nbsp;&nbsp;</a>&nbsp;&nbsp;
                            <a class="btn btn-secondary" href="/Laporan_Gudang/Petunjuk_Obat/<?= $O['KODE_OBAT']; ?>">&nbsp;&nbsp;Print&nbsp;&nbsp;</a>&nbsp;&nbsp;
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade bd-example-modal-lg" id="UpdateObat" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <form action="/Gudang/Obat/Update_Obat">
                        <?= csrf_field(); ?>
