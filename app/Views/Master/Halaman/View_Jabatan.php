...
<div class="container Konten">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav btn-Konten">
                    <li class="nav-item active">
                        <a class="nav-link link-halaman Konten-Terpilih" href="/Master/Jabatan">Jabatan</a>
                    </li>
                    <li class="nav-item active ">
    ...
    <div class="container Sub-Konten">
        <p class="Judul-Sub-Konten">Jabatan
                ...
                <?php foreach ($jabatan as $j) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/Master/Jabatan/Hapus/<?= $j['KODE_JABATAN']; ?>" onclick="return confirm('Anda Yakin Menghapus Jabatan ( <?= $j['NAMA_JABATAN']; ?> ) !!!')">
...
<div class="modal fade" id="InsertJabatan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/Master/Jabatan/Save">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <!-- Input1 -->
                    <div class="form-group">
                        <label for="ID_JABATAN" class="col-form-label">ID Jabatan : </label>
                        <input type="text" class="form-control" id="ID_JABATAN" name="ID_JABATAN" placeholder="Masukan ID Jabatan" required>
                    </div>
                    <div class="form-group">
