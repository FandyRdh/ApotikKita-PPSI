...
<body>
    <nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container">
            <a class="navbar-brand" href="">Apotik Kita</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto btn-halaman">
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Dashboard">Dashboard</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Database">Database</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Master/Jabatan">Master</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link link-halaman" href="/Laporan">Laporan</a>
                    </li>
                </ul>
